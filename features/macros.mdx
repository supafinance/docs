---
title: "Macros"
description: "If you've used execel you know what we are talking about"
---
...
- **Usage**: This mode is utilized when a decentralized application (dApp) does not support transaction simulations.
- **Process**:
  ...
  - To save these transactions as a macro, simply click on `Save Macro`.
