...
To start, simply enter the URL of the crypto protocol you wish to interact with. Note: Some (dApps) may block iframes. If this occurs, alternative interaction methods must be used, or contact the protocol developers and request they enable iframe support for supa.finance.
